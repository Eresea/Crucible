...
- `crucible-ui` for the custom retained editor UI, dock layout, text rendering, asset browser, and script editor foundation.
...
crates/
  ...
  crucible-ui/           Custom retained editor UI and dockable panels.
docs/
